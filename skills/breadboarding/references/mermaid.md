...
> Reference for the breadboarding skill. Consult this when rendering affordance tables to a Mermaid diagram — line styles, colors, subgraph/Place-ID conventions, multi-system layout, and step annotations.
