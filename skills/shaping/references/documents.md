...
> Reference for the `shaping` skill — the roles of each shaping document, the document lifecycle, capturing source material, and file management. The required frontmatter rule and the consistency principle stay in SKILL.md.
