...
> Reference for the `shaping` skill. The core idea — what a spike is and when to use one — stays in SKILL.md; this is the full procedure: file management, structure, and the acceptance/question guidelines.
